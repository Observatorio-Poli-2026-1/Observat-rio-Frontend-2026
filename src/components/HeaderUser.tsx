  ...
  return (
    <header className="bg-slate-100 shadow-sm border-b border-gray-200 text-primary-color h-[10vh] w-full flex justify-between items-center px-4">
      <Nav className="flex flex-1 items-center">
        <Nav.Link href="/" className="mr-6 relative flex items-center text-primary-color hover:text-blue-600 transition-colors" title="Voltar para o Inicio">
