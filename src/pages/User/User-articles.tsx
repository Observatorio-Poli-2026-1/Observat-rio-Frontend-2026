...
function Userarticles () {
  ...
  const handlePost = () => {
    ...
    const requiredFieldsAreFilled =
      isNonEmptyString(NewArticle.titulo) &&
      isNonEmptyString(NewArticle.tema) &&
      isNonEmptyString(NewArticle.descricao) &&
      isNonEmptyString(NewArticle.resumo) &&
      isNonEmptyString(NewArticle.data) &&
      isNonEmptyString(NewArticle.equipe) &&
      isNonEmptyString(NewArticle.palavras_chave);

    if (!requiredFieldsAreFilled) {
      toast.error('Preencha todos os campos obrigatórios antes de enviar o artigo.');
      return;
    }
    ...
    const NewArticleWithDefaults = {
      ...
      tema: NewArticle.tema.trim(),
      palavras_chave: palavrasChaveArray,
      descricao: NewArticle.descricao.trim(),
      equipe: equipeArray,
      data: NewArticle.data.trim(),
      arquivo: NewArticle.arquivo || '#',
      revisado: NewArticle.revisado || "Pendente",
      resumo: NewArticle.resumo.trim(),
    };
